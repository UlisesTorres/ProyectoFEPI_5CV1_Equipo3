...
<template>
    <PublicLayout title="Consulta tus Infracciones">
            ...
            <div class="max-w-md mx-auto">
                ...
                <div class="bg-white dark:bg-gray-800 shadow-xl rounded-2xl p-8 border border-gray-200 dark:border-gray-700">
                    <form @submit.prevent="submit" class="space-y-6">
                        <div>
                            <label for="placa" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">
                                Placa del Vehículo
                            </label>
                            <div class="relative">
                                <input
                            ...
                            <div v-if="form.errors.placa" class="mt-2 text-sm text-red-600 dark:text-red-400 flex items-center">
                        ...
                        >
                            ...
                            <span v-else>Consultar Infracciones</span>
                        </button>
                    </form>

                    <div class="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                        <p class="text-xs text-center text-gray-500 dark:text-gray-400">
                            Ingresa la placa del vehículo para consultar las infracciones registradas en la Ciudad de México
                        </p>
                    </div>
                </div>
            </div>
