            ...
            <nav class="bg-white border-b border-gray-100">
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between items-center h-16">
                        ...
                        <div class="hidden sm:flex sm:items-center absolute left-1/2 transform -translate-x-1/2">
                            <Link
                                :href="route('infocdmx.reportes')"
                                :class="route().current('infocdmx.reportes') ? 'border-red-400' : 'border-transparent'"
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': !showingNavigationDropdown}" class="sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        <Link
                            :href="route('infocdmx.reportes')"
                            :class="route().current('infocdmx.reportes') ? 'border-red-400 text-red-700 bg-red-50' : 'border-transparent'"
